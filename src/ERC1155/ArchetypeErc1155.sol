...
contract ArchetypeErc1155 is Initializable, ERC1155Upgradeable, OwnableUpgradeable, ERC2981Upgradeable {
    ...
    function validateAndCreditMint(
        ...
        uint128 cost = uint128(
            ArchetypeLogicErc1155.computePrice(
                invite, config.affiliateDiscount, args.totalQuantity, args.listSupply, args.affiliate != address(0)
            )
        );

        ArchetypeLogicErc1155.validateMint(
            archetypeAddresses(), invite, config, auth, _minted, _tokenSupply, signature, args, cost
        );
        ...
        ArchetypeLogicErc1155.updateBalances(
            archetypeAddresses(), invite, config, _ownerBalance, _affiliateBalance, affiliate, args.totalQuantity, cost
        );
    ...
    function withdrawTokens(address[] memory tokens) public {
        ArchetypeLogicErc1155.withdrawTokens(archetypeAddresses(), payoutConfig, _ownerBalance, owner(), tokens);
    }
    ...
    function withdrawTokensAffiliate(address[] memory tokens) public {
        ArchetypeLogicErc1155.withdrawTokensAffiliate(archetypeAddresses(), _affiliateBalance, tokens);
    }
